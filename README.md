...
arrastar ou passar o mouse por cima), ela encolhe com uma animação fluida
(a barra inteira "derrete" pra um cartãozinho quadrado com camadas
empilhadas atrás, tipo um deck de cards) mostrando só o equalizer se
mexendo. Acima dele aparece um cartão translúcido e borrado com QR code
convidando pra um apoio via Pix.

Se passar mais 5 segundos sem interação, esse cartão de doação também
cresce um pouco e o texto some, deixando só o QR code maior e mais limpo.

Clicar no botãozinho recolhido (ou passar o mouse/mexer em qualquer
controle) expande a hotbar de novo, com a mesma animação fluida, e
